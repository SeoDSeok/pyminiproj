...
def img_read(file_name, resize):
    ...
    return img
person_static = img_read("./gameproject3/man_static",0.15)
person_size = person_static.get_size()
p_list = [img_read("./gameproject3/man_0",0.15),img_read("./gameproject3/man_1",0.15),img_read("./gameproject3/man_2",0.15),
          img_read("./gameproject3/man_3",0.15),img_read("./gameproject3/man_2",0.15),img_read("./gameproject3/man_1",0.15)]
class person:
    def __init__(self):
