...
def img_read(file_name, resize):
    ...
    return img
person_static = img_read("./gameproject3/char_static",0.15)
person_size = person_static.get_size()
p_list = [img_read("./gameproject3/char_0",0.15),img_read("./gameproject3/char_1",0.15),img_read("./gameproject3/char_2",0.15),
          img_read("./gameproject3/char_3",0.15)]
b_r = 0.15
b_list = [[img_read("./gameproject3/bird_0_0",b_r), img_read("./gameproject3/bird_0_1",b_r),img_read("./gameproject3/bird_0_2",b_r),img_read("./gameproject3/bird_0_3",b_r),img_read("./gameproject3/bird_0_2",b_r),img_read("./gameproject3/bird_0_1",b_r)],
          [img_read("./gameproject3/bird_1_0",b_r), img_read("./gameproject3/bird_1_1",b_r),img_read("./gameproject3/bird_1_2",b_r),img_read("./gameproject3/bird_1_3",b_r),img_read("./gameproject3/bird_1_2",b_r),img_read("./gameproject3/bird_1_1",b_r)],
          [img_read("./gameproject3/bird_2_0",b_r), img_read("./gameproject3/bird_2_1",b_r),img_read("./gameproject3/bird_2_2",b_r),img_read("./gameproject3/bird_2_3",b_r),img_read("./gameproject3/bird_2_2",b_r),img_read("./gameproject3/bird_2_1",b_r)]]
class person:
    def __init__(self):
