...
def sound_read(file_name):
    ...
    return sound
sound_drop = sound_read("./gameproject3/drop")
sound_sad = sound_read("./gameproject3/sad") 
...
def img_read(file_name, resize):
    img = pygame.image.load("./gameproject3/"+file_name+".png")
...
point_font = pygame.font.SysFont("malgungothic", 50)
finalp_font = pygame.font.SysFont("malgungothic", 80)
ready_font = pygame.font.SysFont("malgungothic", 80)
ready2_font = pygame.font.SysFont("malgungothic", 20)
